...
<head>
	<title>Online Course Platforma Kayıt Olun</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<form action="{{route('register')}}" class="login100-form validate-form" method="post">
					...
					<span class="login100-form-title">
						Online Course Platformuna Üye Ol
					</span>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<select class="input100" name="role">
							<option disabled selected>Giriş Yönteminizi Seçin</option>
							<option value="stu">Kurs Almak İstiyorum</option>
							<option value="tch">Kurs Eğitimi Vermek İstiyorum</option>
						</select>
