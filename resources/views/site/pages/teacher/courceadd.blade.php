    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="{{route('home')}}">AnaSayfa</a> <span class="mx-2 mb-0">/</span> <strong
                    class="text-black">Kurs Eğitimi Oluştur</strong></div>
        </div>
    </div>
</div>
...
<div class="site-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Online E-Kurs Eğitim Verin</h2>
            </div>
            <div class="col-md-12">
                @if ($errors)
                ...
                <form action="{{route('course.create')}}" method="post">
                    ...
                    <div class="p-3 p-lg-5 border">
                        ...
                        <div class="form-group row">
                            <div class="col-md-5">
                                <label for="c_fname" class="text-black">Kursun Kategorisi<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="1">Beklemeye Al</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <button type="submit" class="btn btn-primary btn-lg btn-block">Kursu Eğitimi Ver</button>
                            </div>
                        </div>
                    </div>
                </form>
